            ...
            <main className="d-flex flex-column page pricing-table-page">
              <section className="d-flex flex-grow-0 flex-shrink-1 clean-block clean-pricing dark" style={{height: '660px'}}>
                <div className="card d-flex flex-column flex-shrink-1 align-items-center" style={{width: '400px', height: '550px', margin: '30px'}}>
                  <picture><img className="rounded-circle" src="assets/img/13nfl-matchups-kc-videoSixteenByNine3000.jpg" style={{width: '200px', height: '200px', marginTop: '25px', marginBottom: '10px'}} /></picture>
              ...
              <section className="clean-block clean-pricing dark d-flex flex-row" style={{height: '500px'}}>
                <div>
                  ...
                  <div className="container">
                    <div className="card">
                      <div className="card-body d-flex flex-row align-items-center" style={{width: '1287px', height: '59.984px', borderRadius: '4px', borderBottom: '2px inset rgb(217,217,217)'}}><img className="rounded-circle" width={100} height={80} style={{width: '40px', height: '40px'}} src="assets/img/avatars/avatar1.jpg" />
                      ...
                      <div className="card-body d-flex flex-row align-items-center" style={{width: '1287px', height: '59.984px', borderRadius: '4px', borderBottom: '2px inset rgb(217,217,217)'}}><img className="rounded-circle" width={100} height={80} style={{width: '40px', height: '40px'}} src="assets/img/avatars/avatar2.jpg" />
                        <div className="col" style={{marginBottom: '11px'}}>
                      ...
                      <div className="card-body d-flex flex-row align-items-center" style={{width: '1287px', height: '59.984px', borderRadius: '4px', borderBottom: '2px inset rgb(217,217,217)'}}><img className="rounded-circle" width={100} height={80} style={{width: '40px', height: '40px'}} src="assets/img/scenery/image6.jpg" />
                        <div className="col" style={{marginBottom: '11px'}}>
                      ...
                      <div className="card-body d-flex flex-row align-items-center" style={{width: '1287px', height: '59.984px', borderRadius: '4px', borderBottom: '2px inset rgb(217,217,217)'}}><img className="rounded-circle" width={100} height={80} style={{width: '40px', height: '40px'}} src="assets/img/scenery/image5.jpg" />
                        <div className="col" style={{marginBottom: '11px'}}>
